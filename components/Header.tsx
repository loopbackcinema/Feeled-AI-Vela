        ...
        <header className="w-full bg-white shadow-sm border-b border-slate-100">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                <div className="text-left">
                    ...
                    <p className="text-slate-500 text-sm mt-1">Feel the story. Learn naturally.</p>
                </div>
                <button
                    onClick={handleFeedbackClick}
                    className="flex items-center gap-2 bg-[#25D366] text-white font-bold py-2 px-4 rounded-lg hover:bg-green-600 transition-all transform hover:scale-105 shadow-md"
                >
