                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col gap-4">
                            <a 
                                ...
                                className="flex items-center gap-3 text-sm font-bold text-slate-600 hover:text-[#0A66C2] transition-all group"
                            >
                                <span className="p-2.5 bg-slate-50 rounded-xl group-hover:bg-[#0A66C2]/10 group-hover:scale-110 transition-all shadow-sm">
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="flex items-center gap-3 text-sm font-bold text-slate-600 hover:text-[#FF0000] transition-all group"
                            >
                                <span className="p-2.5 bg-slate-50 rounded-xl group-hover:bg-[#FF0000]/10 group-hover:scale-110 transition-all shadow-sm">
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="flex items-center gap-3 text-sm font-bold text-slate-600 hover:text-[#1877F2] transition-all group"
                            >
                                <span className="p-2.5 bg-slate-50 rounded-xl group-hover:bg-[#1877F2]/10 group-hover:scale-110 transition-all shadow-sm">
                            ...
                            <a 
                                ...
                                target="_blank" 
                                rel="noopener noreferrer" 
                                className="flex items-center gap-3 text-sm font-bold text-slate-600 hover:text-[#E4405F] transition-all group"
                            >
                                <span className="p-2.5 bg-slate-50 rounded-xl group-hover:bg-[#E4405F]/10 group-hover:scale-110 transition-all shadow-sm">
