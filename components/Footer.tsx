        ...
        <footer className="w-full bg-white border-t border-slate-100 mt-auto">
            <div className="container mx-auto px-4 py-12 text-center text-slate-500">
                ...
                <div className="flex justify-center items-center gap-6 mb-8">
                    ...
                    <a href="https://www.youtube.com/channel/UCGhL6cCR9-ZOGUEroMxPArw" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-red-600 transition-all transform hover:scale-110">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=61584338379138" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-800 transition-all transform hover:scale-110">
