...
const StoryDisplay: React.FC<StoryDisplayProps> = ({ story, base64Audio, isAudioLoading, base64Image, imageMimeType, isImageLoading, onTryAnother }) => {
    ...
    const handleShareInstagram = () => {
        const storyText = getStoryAsText();
        navigator.clipboard.writeText(storyText).then(() => {
            alert("Story text copied to clipboard! Paste it in your Instagram post.");
        }).catch(err => {
            console.error('Could not copy text: ', err);
            alert("To share on Instagram, please copy the story text and post it from your app.");
        });
    };
