...
const StorySection: React.FC<{ title: string; content: string }> = ({ title, content }) => (
    <div className="mb-6 bg-slate-50 p-6 rounded-2xl border-l-8 border-indigo-400 shadow-sm transition-transform hover:translate-x-2">
...
const QuizSection: React.FC<QuizSectionProps> = ({ quiz, onQuizComplete }) => {
    ...
    return (
        <div className="mt-16 bg-white p-8 md:p-12 rounded-[3.5rem] border-4 border-indigo-50 shadow-2xl">
        ...
        <div className="w-full max-w-4xl mx-auto animate-fade-in pb-32 px-4 print:max-w-full">
            ...
            <div className="text-center mb-16 space-y-6">
                ...
                <div className="flex justify-center gap-4 no-print">
                    ...
                    <button onClick={handlePrint} className="flex items-center gap-2 px-5 py-2 rounded-full bg-slate-900 text-white font-black text-xs uppercase hover:bg-slate-800 transition">
            ...
            <div className="mb-16 transform transition-all hover:scale-[1.01]">
                {isImageLoading ? (
                    <div className="w-full aspect-video bg-indigo-50 rounded-[3rem] animate-pulse border-4 border-white shadow-xl flex items-center justify-center">
                        <p className="text-indigo-300 font-black text-xl">Creating mental imagery...</p>
                    </div>
                ) : base64Image && (
                    <div className="relative rounded-[3rem] overflow-hidden border-[12px] border-white shadow-3xl ring-2 ring-slate-100">
