            ...
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className="flex items-center gap-2 bg-[#25D366] text-white font-black py-2.5 px-5 rounded-full hover:bg-[#1fb855] focus:outline-none focus:ring-4 focus:ring-green-100 transition-all transform hover:scale-105 shadow-lg shadow-green-100"
                    >
