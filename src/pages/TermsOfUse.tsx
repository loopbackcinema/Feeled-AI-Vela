...
const TermsOfUse: React.FC<TermsOfUseProps> = ({ onNavigate }) => {
    return (
        <div className="w-full max-w-3xl mx-auto px-6 py-10 text-gray-900 dark:text-gray-100">
            ...
            {/* Hero */}
            <div className="mb-10">
                <h1 className="text-3xl font-bold mb-1 text-gray-900 dark:text-white">Terms of Use</h1>
            ...
            <div className="space-y-0">
                ...
                {/* Section 1 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">1. Eligibility</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                {/* Section 2 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">2. Educational Purpose</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                {/* Section 3 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">3. User Accounts</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                {/* Section 4 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">4. Acceptable Use</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">Users agree not to:</p>
                ...
                {/* Section 5 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">5. AI-Generated Educational Content</h2>
                ...
                {/* Section 6 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">6. Privacy</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                {/* Section 7 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">7. Intellectual Property</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                {/* Section 8 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">8. Platform Availability</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                {/* Section 9 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">9. Limitation of Liability</h2>
                    <div className="bg-amber-50 dark:bg-amber-950/50 border-l-4 border-amber-500 p-4 rounded">
                        <p className="text-sm leading-relaxed text-gray-700 dark:text-gray-300">
                ...
                {/* Section 10 */}
                <section className="border-b border-gray-100 dark:border-gray-800 pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">10. Updates to These Terms</h2>
                    <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                ...
                <section className="pb-8 mb-8">
                    <h2 className="text-lg font-bold mb-3 text-gray-900 dark:text-white">11. Contact Information</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">For questions regarding these Terms:</p>
            ...
            {/* Footer note */}
            <p className="text-xs text-center text-gray-400 dark:text-gray-600 pt-8 border-t border-gray-200 dark:border-gray-800">
