    ...
    return (
        <div className="w-full max-w-5xl mx-auto animate-fade-in pb-12">
            ...
            <div className="text-center space-y-4 py-8 mb-4">
                <div className="inline-block p-3 rounded-2xl bg-slate-100 text-slate-600 mb-2 shadow-sm">
                    <span className="text-4xl">🔒</span>
                </div>
                <h1 className="text-4xl md:text-5xl font-black text-slate-800 tracking-tight">
                    Privacy <span className="text-blue-600">Policy</span>
                </h1>
                <p className="text-slate-500 font-medium">Last Updated: October 2025</p>
            </div>

            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100 space-y-10 text-slate-700 leading-relaxed">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                        <span className="bg-blue-100 text-blue-600 px-3 py-1 rounded-lg text-lg">1</span> Information We Collect
                    </h2>
                    <p className="mb-4">We follow a minimal data collection approach and collect only what is necessary to provide a safe and personalized learning experience.</p>
                    
                    <div className="grid md:grid-cols-2 gap-6 mt-6">
                        <div className="bg-slate-50 p-6 rounded-2xl">
                            <h3 className="font-bold text-slate-800 mb-3">1.1 Information You Provide</h3>
                        ...
                        <div className="bg-slate-50 p-6 rounded-2xl">
                            <h3 className="font-bold text-slate-800 mb-3">1.2 Automatically Collected</h3>
                            <ul className="list-disc list-inside space-y-2 text-sm">
                    ...
                    <div className="mt-6 bg-red-50 p-6 rounded-2xl border border-red-100">
                        <h3 className="font-bold text-red-800 mb-3">1.3 What We Do Not Collect</h3>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                        <span className="bg-green-100 text-green-600 px-3 py-1 rounded-lg text-lg">2</span> How We Use Your Information
                    </h2>
                    <p className="mb-4">We use the collected data strictly to provide, improve, and secure our services.</p>
                    
                    <div className="grid md:grid-cols-2 gap-8">
                        <div>
                            <h3 className="font-bold text-green-700 mb-3">✅ We use data to:</h3>
                        ...
                        <div>
                            <h3 className="font-bold text-red-700 mb-3">🚫 We do NOT:</h3>
                            <ul className="space-y-2 text-sm">
                    ...
                    <p className="mt-4 text-sm font-semibold text-slate-600 bg-slate-50 p-3 rounded-lg inline-block">
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                        <span className="bg-purple-100 text-purple-600 px-3 py-1 rounded-lg text-lg">3</span> Data Storage & Security
                    </h2>
                    <p className="mb-4">We take privacy seriously and implement industry-standard protection.</p>
                    
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-purple-50 p-6 rounded-2xl border border-purple-100">
                            <h3 className="font-bold text-purple-900 mb-3">Security Measures</h3>
                        ...
                        <div className="bg-indigo-50 p-6 rounded-2xl border border-indigo-100">
                            <h3 className="font-bold text-indigo-900 mb-3">Emotion Data Protection</h3>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                        <span className="bg-amber-100 text-amber-600 px-3 py-1 rounded-lg text-lg">4</span> Your Rights
                    </h2>
                    <p className="mb-4">You have full control over your data. You may request to:</p>
                    ...
                    <div className="mt-4 bg-amber-50 p-4 rounded-xl border border-amber-100">
                        <p className="font-medium text-amber-900">To exercise these rights, contact us at:</p>
                        <a href="mailto:feeledai@gmail.com" className="text-blue-600 font-bold hover:underline">feeledai@gmail.com</a>
                        <p className="text-xs text-amber-700 mt-1">We process data requests within 7–14 business days.</p>
                    </div>
                </section>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                        <span className="bg-pink-100 text-pink-600 px-3 py-1 rounded-lg text-lg">5</span> Children’s Privacy
                    </h2>
                    <p className="mb-4">FeelEd AI is designed for learners 13 years and above, ideally with teacher or guardian guidance.</p>
                    <div className="bg-pink-50 border-l-4 border-pink-400 p-4 rounded-r-xl">
                        <p className="font-bold text-pink-900 mb-2">We do not:</p>
                        ...
                        <p className="mt-3 text-xs text-pink-700">If we discover an underage account created without consent, we will delete it promptly.</p>
                    </div>
                </section>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    <section>
                        <h2 className="text-xl font-bold text-slate-800 mb-3">6. Changes to Policy</h2>
                    ...
                    <section>
                        ...
                        <p className="text-sm text-slate-600 mb-2">For any privacy, data protection, or security-related questions:</p>
                        <div className="space-y-1 text-sm font-medium">
                            <p>📧 <a href="mailto:contact@feeledai.com" className="text-blue-600 hover:underline">contact@feeledai.com</a></p>
                            <p>📩 <a href="mailto:feeledai@gmail.com" className="text-blue-600 hover:underline">feeledai@gmail.com</a></p>
                            <p>📞 +91 90924 50286</p>
                            <p>📍 Chennai, India</p>
                        </div>
                    </section>
