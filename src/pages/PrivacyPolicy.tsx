...
const PrivacyPolicy: React.FC<PrivacyPolicyProps> = ({ onNavigate }) => {
    return (
        <div className="w-full max-w-3xl mx-auto px-6 py-10 text-slate-900 dark:text-slate-100">
            ...
            <div className="space-y-10">
                ...
                <section>
                    ...
                    <div className="space-y-5">
                        <div>
                            <h3 className="text-base font-semibold text-slate-700 dark:text-slate-300 mb-2">1.1 Information Provided by Users</h3>
                        ...
                        <div>
                            <h3 className="text-base font-semibold text-slate-700 dark:text-slate-300 mb-2">1.2 Automatically Collected Information</h3>
                            <ul className="space-y-1.5">
                                {[
                        ...
                        <div>
                            <h3 className="text-base font-semibold text-slate-700 dark:text-slate-300 mb-2">1.3 Information We Do Not Collect</h3>
                            <ul className="space-y-1.5">
                                {[
                ...
                {/* Section 2 */}
                <section>
                    <h2 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">2. How We Use Information</h2>
                ...
                {/* Section 3 */}
                <section>
                    <h2 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">3. Data Storage & Security</h2>
                    <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 mb-4">
                ...
                {/* Section 4 */}
                <section>
                    <h2 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">4. Children's Privacy</h2>
                    <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 mb-4">
                    ...
                    <p className="text-sm font-semibold text-slate-700 dark:text-slate-300 mb-2">We do not knowingly:</p>
                ...
                {/* Section 5 */}
                <section>
                    <h2 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">5. User Rights & Account Requests</h2>
                    <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 mb-4">
                ...
                {/* Section 6 */}
                <section>
                    <h2 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">6. Policy Updates</h2>
                    <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                ...
                {/* Section 7 */}
                <section>
                    <h2 className="text-xl font-bold mb-3 text-slate-900 dark:text-white">7. Contact Information</h2>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">For privacy, security, or data-related enquiries:</p>
            ...
            {/* Footer note */}
            <p className="text-xs text-center text-slate-400 dark:text-slate-600 mt-12 pt-8 border-t border-slate-200 dark:border-slate-800">
