...
const Teachers: React.FC<TeachersProps> = ({ onNavigate }) => {
    return (
        <div className="w-full max-w-5xl mx-auto space-y-24 animate-fade-in py-12 px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                <div className="bg-slate-50 p-12 rounded-[4rem] border border-slate-200 shadow-xl space-y-10">
                    ...
                    <div className="p-6 bg-white rounded-3xl border border-slate-200">
                        <p className="text-slate-500 font-bold">It acts as a supportive layer — helping learning materials respond more gently to student states like hesitation, fatigue, or curiosity.</p>
                    </div>
                </div>
                ...
                <div className="bg-white p-12 rounded-[4rem] border-2 border-slate-100 shadow-sm space-y-10">
                    ...
                    <p className="text-slate-400 font-bold">Traditional tools treat learning as uniform. Classrooms are not.</p>
                </div>
            </div>

            {/* Explorations */}
            <div className="bg-indigo-600 text-white p-20 rounded-[5rem] shadow-4xl text-center space-y-16 relative overflow-hidden">
            ...
            {/* What it does NOT do */}
            <div className="bg-rose-50 border-4 border-white p-12 md:p-24 rounded-[4rem] shadow-2xl space-y-12">
                <h3 className="text-4xl font-black text-rose-900 text-center">What FeelEd AI Does NOT Do (Important)</h3>
                <div className="grid md:grid-cols-2 gap-12 text-xl font-bold text-rose-800/80">
                    <ul className="space-y-6">
                ...
                <div className="p-8 bg-white/60 rounded-[3rem] border border-rose-200 text-center">
                    <p className="text-2xl font-black text-rose-900 uppercase tracking-widest italic">Teachers remain in full control of classroom decisions.</p>
                </div>
            </div>

            {/* Teacher's Role / Gains */}
            <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-white p-16 rounded-[4rem] border border-slate-100 shadow-sm space-y-10">
                    <h3 className="text-3xl font-black text-slate-900">The Teacher’s Role</h3>
                    <p className="text-sm font-black text-slate-400 uppercase tracking-widest">(Central, Not Optional)</p>
                ...
                <div className="bg-emerald-50 p-16 rounded-[4rem] border border-emerald-100 shadow-sm space-y-10">
                    <h3 className="text-3xl font-black text-emerald-900">Pilot Program Gains</h3>
                    <ul className="space-y-4 text-emerald-700 font-bold text-lg">
                    ...
                    <p className="text-xs font-black text-emerald-600 uppercase tracking-widest">This is collaboration — not compliance.</p>
                </div>
            </div>
