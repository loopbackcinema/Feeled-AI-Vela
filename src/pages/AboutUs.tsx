...
const AboutUs: React.FC<AboutUsProps> = ({ onNavigate }) => {
    return (
        <div className="w-full max-w-3xl mx-auto px-6 py-10 text-gray-900 dark:text-gray-100">
            ...
            {/* Hero */}
            <div className="mb-10">
                <h1 className="text-3xl font-bold mb-2 text-gray-900 dark:text-white">About FeelEd AI</h1>
                <p className="text-base text-gray-500 dark:text-gray-400 mb-6">AI-powered learning designed for Indian students.</p>
            ...
            {/* Why We Built It */}
            <div className="mb-10">
                <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Why We Built FeelEd AI</h2>
                <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
            ...
            {/* What We Offer */}
            <div className="mb-10">
                <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-white">What FeelEd AI Offers</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={card.title} className="border border-gray-200 dark:border-gray-800 rounded-xl p-5 bg-white dark:bg-gray-900">
                            ...
                            <h3 className="font-semibold text-sm mb-2 text-gray-900 dark:text-white">{card.title}</h3>
                            <p className="text-sm leading-relaxed text-gray-600 dark:text-gray-400">{card.desc}</p>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="mb-10">
                <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">What Makes FeelEd AI Different</h2>
                <ul className="space-y-2">
                    {[
                        ...
                        <li key={item} className="flex items-start gap-3 text-base leading-relaxed text-gray-600 dark:text-gray-400">
            ...
            {/* Vision */}
            <div className="mb-10">
                <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Our Vision</h2>
                <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
            ...
            {/* Founder */}
            <div className="mb-10">
                <h2 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Founder</h2>
                <p className="text-base leading-relaxed text-gray-600 dark:text-gray-400">
