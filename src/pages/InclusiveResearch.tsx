        ...
        <div className="w-full max-w-5xl mx-auto space-y-24 animate-fade-in py-12 px-6 pb-32">
            ...
            <div className="text-center space-y-8">
                <div className="inline-flex items-center gap-4 px-8 py-2.5 rounded-full bg-slate-900 text-white text-[10px] font-black uppercase tracking-[0.4em] border border-slate-700 shadow-2xl">
                    Specialized Research Domain: Neuro-Accessibility
                </div>
            ...
            <div className="bg-white border-2 border-slate-200 p-12 md:p-24 rounded-[4rem] shadow-2xl space-y-12 relative overflow-hidden">
                ...
                <h2 className="text-4xl font-black text-slate-900 tracking-tight flex items-center gap-4">
                    <span className="text-blue-500">📍</span> Position Statement
                </h2>
                <div className="space-y-8 text-2xl text-slate-600 leading-relaxed font-medium">
                    <p>
                        FeelEd AI’s work with blind and deaf children is an ongoing collaborative research initiative. We explore how emotion-adaptive storytelling can support inclusive learning experiences responsibly and ethically.
                    </p>
                    <div className="p-10 bg-slate-900 text-white rounded-[3rem] font-bold shadow-3xl border-b-[12px] border-indigo-600/30">
                        "We do not seek to 'fix' sensory differences. We seek to design learning environments that respect diverse sensory realities as valid ways of knowing."
                    </div>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                <div className="space-y-8 p-12 bg-slate-50 rounded-[4rem] border border-slate-200">
                    ...
                    <p className="text-lg text-slate-500 font-bold leading-relaxed">
                        Traditional EdTech assumes a "Sensory Baseline" (Vision/Hearing). This creates an invisible wall for learners who experience the world through different channels.
                    </p>
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 text-rose-600 font-black"><span>❌</span> Visual-only progress tracking</div>
                        <div className="flex items-center gap-4 text-rose-600 font-black"><span>❌</span> Audio-centric emotional signaling</div>
                    </div>
                </div>
                <div className="space-y-8 p-12 bg-indigo-600 rounded-[4rem] text-white shadow-2xl">
                    <h3 className="text-3xl font-black">The FeelEd Solution</h3>
                    <p className="text-lg text-indigo-100 font-bold leading-relaxed">
                        We hypothesize that emotional intelligence can translate across modalities. A story can "feel" the same through rhythm and vibration as it does through a visual scene.
                    </p>
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 text-indigo-200 font-black"><span>✅</span> Audio-Descriptive Storytelling</div>
                        <div className="flex items-center gap-4 text-indigo-200 font-black"><span>✅</span> Visual-Rhythm Narrative Pacing</div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-white p-16 rounded-[4rem] border-2 border-slate-100 shadow-sm space-y-10 hover:border-indigo-200 transition-colors">
                    ...
                    <ul className="space-y-6">
                        {[
                            "Audio-first narrative structures",
                            "Emotion conveyed via vocal rhythm & pacing",
                            "High-fidelity descriptive environment design",
                            "Spatial sound used as emotional metadata"
                        ].map((item, i) => (
                ...
                <div className="bg-white p-16 rounded-[4rem] border-2 border-slate-100 shadow-sm space-y-10 hover:border-indigo-200 transition-colors">
                    ...
                    <ul className="space-y-6">
                        {[
                            "Visual rhythm-based narrative flow",
                            "Sign-language friendly text structures",
                            "Emotion expressed via timing and motion cues",
                            "Kinetic typography for emotional intensity"
                        ].map((item, i) => (
                            <li key={i} className="flex items-start gap-4 text-slate-700 font-bold">
                                <span className="text-indigo-500 mt-1">●</span> {item}
                            </li>
            ...
            <div className="bg-emerald-50 p-16 md:p-24 rounded-[4rem] border-2 border-emerald-100 shadow-sm space-y-12">
                <h2 className="text-4xl font-black text-emerald-900 text-center">Ethics & Safeguards</h2>
                <div className="grid md:grid-cols-2 gap-12">
                    <div className="space-y-6 text-xl font-bold text-emerald-700">
                        ...
                        <p className="flex items-center gap-4"><span className="w-2 h-2 bg-emerald-500 rounded-full"></span> No facial analysis or labeling</p>
                        <p className="flex items-center gap-4"><span className="w-2 h-2 bg-emerald-500 rounded-full"></span> Guardian & Educator oversight only</p>
                        <p className="flex items-center gap-4"><span className="w-2 h-2 bg-emerald-500 rounded-full"></span> Non-clinical, learning-focused pilots</p>
                    </div>
                    <div className="p-10 bg-white rounded-[3rem] border border-emerald-200 shadow-sm flex items-center justify-center">
                        <p className="text-emerald-900 leading-relaxed font-black text-center text-2xl italic">
                            "Innovation must never come at the cost of child privacy or dignity."
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="text-center space-y-12">
                ...
                <p className="text-2xl text-slate-500 font-bold max-w-3xl mx-auto">
                    We invite Special Education Teachers and Researchers to co-create these adaptive models.
                </p>
