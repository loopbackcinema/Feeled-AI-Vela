    ...
    return (
        <div className="w-full max-w-5xl mx-auto space-y-24 animate-fade-in py-12 px-6 pb-32 transition-colors duration-300">
            ...
            <div className="text-center space-y-8">
                <div className="inline-flex items-center gap-4 px-8 py-2.5 rounded-full bg-slate-900 dark:bg-slate-800 text-white text-[10px] font-black uppercase tracking-[0.4em] border border-slate-700 dark:border-slate-600 shadow-2xl">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
                <div className="space-y-8 p-12 bg-slate-50 dark:bg-slate-800/50 rounded-[4rem] border border-slate-200 dark:border-slate-800 transition-colors">
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white">The Problem</h3>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4 text-rose-600 dark:text-rose-400 font-black"><span>❌</span> Visual-only progress bars</div>
                        <div className="flex items-center gap-4 text-rose-600 dark:text-rose-400 font-black"><span>❌</span> Audio-only emotional cues</div>
                        <div className="flex items-center gap-4 text-rose-600 dark:text-rose-400 font-black"><span>❌</span> Static, non-descriptive content</div>
                    </div>
                </div>
                <div className="space-y-8 p-12 bg-indigo-600 dark:bg-indigo-700 rounded-[4rem] text-white shadow-2xl transition-colors">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-slate-900 p-16 rounded-[4rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm space-y-10 hover:border-indigo-200 dark:hover:border-indigo-500 transition-colors">
                    <div className="flex items-center gap-6">
                        <span className="text-5xl">🦯</span>
                        <h3 className="text-3xl font-black text-slate-900 dark:text-white leading-tight">Blind & Low-Vision Research</h3>
                    </div>
                    <p className="text-slate-500 dark:text-slate-400 font-bold italic">Focusing on "Spatial Sound & Descriptive Emotion"</p>
                    <ul className="space-y-6">
                        {[
                            ...
                            <li key={i} className="flex items-start gap-4 text-slate-700 dark:text-slate-300 font-bold">
                                <span className="text-indigo-500 dark:text-indigo-400 mt-1">●</span> {item}
                            </li>
                        ))}
                    </ul>
                </div>
                <div className="bg-white dark:bg-slate-900 p-16 rounded-[4rem] border-2 border-slate-100 dark:border-slate-800 shadow-sm space-y-10 hover:border-indigo-200 dark:hover:border-indigo-500 transition-colors">
                    <div className="flex items-center gap-6">
                        <span className="text-5xl">🤟</span>
                        <h3 className="text-3xl font-black text-slate-900 dark:text-white leading-tight">Deaf & Hard-of-Hearing Research</h3>
                    </div>
                    <p className="text-slate-500 dark:text-slate-400 font-bold italic">Focusing on "Visual Rhythm & Kinetic Typography"</p>
                    <ul className="space-y-6">
                        {[
            ...
            {/* Ethics Protocol */}
            <div className="bg-emerald-50 dark:bg-emerald-900/20 p-16 md:p-24 rounded-[4rem] border-2 border-emerald-100 dark:border-emerald-800 shadow-sm space-y-12 transition-colors">
                <h2 className="text-4xl font-black text-emerald-900 dark:text-emerald-400">Safety & Ethical Constraints</h2>
                <div className="grid md:grid-cols-2 gap-12">
                    <div className="space-y-6 text-xl font-bold text-emerald-700 dark:text-emerald-300">
                    ...
                    <div className="p-10 bg-white dark:bg-slate-800 rounded-[3rem] border border-emerald-200 dark:border-emerald-800 shadow-sm flex items-center justify-center transition-colors">
                        <p className="text-emerald-900 dark:text-emerald-100 leading-relaxed font-black text-center text-2xl italic">
            ...
            <div className="text-center space-y-12">
                <h2 className="text-5xl font-black text-slate-900 dark:text-white tracking-tight">Support This <span className="text-indigo-600 dark:text-indigo-400">Frontier</span></h2>
                ...
                <div className="flex flex-col md:flex-row justify-center gap-8">
                    ...
                    <button onClick={() => onNavigate('research')} className="border-4 border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 px-16 py-8 rounded-full font-black text-2xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-all">
                        Back to Portfolio
                    </button>
                </div>
                <div className="pt-24 border-t border-slate-100 dark:border-slate-800 max-w-xl mx-auto">
