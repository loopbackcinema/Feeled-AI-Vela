...
const InclusiveResearch: React.FC<InclusiveResearchProps> = ({ onNavigate }) => {
    return (
        <div className="w-full max-w-6xl mx-auto space-y-24 animate-fade-in py-12 px-6 pb-32">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
                <div className="space-y-8">
                    ...
                    <div className="bg-indigo-600 text-white p-10 rounded-[3rem] shadow-xl">
                        <p className="text-2xl font-black italic text-center leading-relaxed">"Can learning stories adapt not only to emotion, but also to sensory context?"</p>
                    </div>
                </div>
                <div className="bg-slate-50 p-12 rounded-[4rem] border border-slate-200 shadow-xl space-y-10">
                    <h3 className="text-xl font-black text-slate-400 uppercase tracking-widest">Research Focus Areas</h3>
                    <div className="grid grid-cols-1 gap-6">
                        {[
                            { t: "🦯 For Blind & Low-Vision Learners", d: "Audio-first storytelling, emotional tone through voice, rhythm, and pacing." },
                            { t: "🤟 For Deaf & Hard-of-Hearing Learners", d: "Visual rhythm storytelling, text + sign-language friendly pacing." }
                        ].map((part, i) => (
                            <div key={i} className="p-8 rounded-3xl bg-white border border-slate-100 space-y-2 shadow-sm">
                                <span className="font-black text-slate-800 text-xl block">{part.t}</span>
                                <p className="text-slate-500 font-bold text-sm">{part.d}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="relative z-10 space-y-16">
                    <div className="text-center space-y-6">
                        ...
                        <p className="text-xl text-slate-400 font-bold max-w-3xl mx-auto">
                            This initiative explores iterative, research-guided pathways:
                        </p>
                    </div>
                    <div className="grid md:grid-cols-2 gap-10">
                        {[
                            ...
                            "How inclusive design coexists with mainstream classrooms"
                        ].map((step, i) => (
                            <div key={i} className="flex items-center gap-8 p-10 bg-white/5 rounded-[2.5rem] border border-white/10">
                                <span className="text-indigo-500 font-black text-2xl shrink-0">0{i+1}</span>
            ...
            <div className="bg-emerald-50 p-16 md:p-24 rounded-[4rem] border-2 border-emerald-100 shadow-sm space-y-12">
                ...
                <div className="grid md:grid-cols-2 gap-12 text-xl font-bold text-emerald-800/80">
                    <div className="space-y-6 text-emerald-700 font-bold">
                        ...
                        <p className="flex items-center gap-4"><span className="w-2 h-2 bg-emerald-500 rounded-full"></span> No profiling or emotional labeling</p>
                        <p className="flex items-center gap-4"><span className="w-2 h-2 bg-emerald-500 rounded-full"></span> Only guardian/educator oversight</p>
                    </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-slate-50 p-16 rounded-[4rem] space-y-8 border border-slate-200">
                    ...
                    <p className="text-slate-500 font-bold leading-relaxed">Inclusive learning must be co-created. We invite special education teachers, NGOs, and research foundations to join the dialogue.</p>
                </div>
                <div className="bg-slate-50 p-16 rounded-[4rem] space-y-8 border border-slate-200">
            ...
            <div className="text-center space-y-12">
                <div className="space-y-6">
                    ...
                    <p className="text-2xl text-slate-500 font-bold max-w-3xl mx-auto leading-relaxed">
                        If you believe in thoughtful, ethical experimentation in inclusive education, we welcome dialogue.
                    </p>
                </div>
                <div className="flex flex-col md:flex-row justify-center gap-8">
                    <a 
                        href="mailto:contact@feeledai.com?subject=Inclusive Research Collaboration" 
                ...
                <div className="pt-24 space-y-12 border-t border-slate-100 max-w-3xl mx-auto">
                    <p className="text-3xl font-black text-slate-500 italic leading-relaxed">
                        "Inclusive learning is about changing assumptions."
                    </p>
                </div>
            </div>
        </div>
